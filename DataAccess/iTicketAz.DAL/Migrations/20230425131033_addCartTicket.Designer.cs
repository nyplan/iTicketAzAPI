...
namespace iTicketAz.DAL.Migrations
{
    ...
    [Migration("20230425131033_addCartTicket")]
    partial class addCartTicket
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iTicketAz.DAL.Entities.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("iTicketAz.DAL.Entities.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CartTicket", b =>
                {
                    b.HasOne("iTicketAz.DAL.Entities.Cart", null)
                        .WithMany()
                        .HasForeignKey("CartsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("iTicketAz.DAL.Entities.Ticket", null)
                        .WithMany()
